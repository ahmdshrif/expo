...
- Accept a `SectionList` ref in `useScrollToTop` under React Native's strict types. ([#PRNUMBER](https://github.com/expo/expo/pull/PRNUMBER) by [@ahmdshrif](https://github.com/ahmdshrif))
