...
- Prevent a delayed `popstate` on web from resetting navigation state after a programmatic `history.go()`. ([#PRNUMBER](https://github.com/expo/expo/pull/PRNUMBER) by [@ahmdshrif](https://github.com/ahmdshrif))
